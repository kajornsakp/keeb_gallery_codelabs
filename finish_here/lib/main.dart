...
import 'package:keeb_gallery/image_detail_screen.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void showDetailScreen(BuildContext context, GalleryItemModel model) {
    ...
    return SliverPadding(
      ...
      sliver: SliverWaterfallFlow(
        delegate: SliverChildBuilderDelegate((BuildContext context, int index) {
          ...
          return GestureDetector(
            onLongPress: () {
              _removeSavedItem(context, model);
            },
            onTap: () {
              showDetailScreen(context, model);
            },
  ...
  void _addSavedItem(BuildContext context, GalleryItemModel model) {
    setState(() {
  ...
  void _removeSavedItem(BuildContext context, GalleryItemModel model) {
    setState(() {
      savedItems.remove(model);
    });
    ScaffoldMessenger.of(context)
